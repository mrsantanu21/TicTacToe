...
The goal of the design was to make the game feel calm, modern, and easy to read, while keeping the underlying implementation simple and entirely in Python.<img width="1344" height="896" alt="image" src="https://github.com/user-attachments/assets/eda9d2a8-694e-4a01-b3ef-2d60bff6794e" /><img width="1917" height="1016" alt="image" src="https://github.com/user-attachments/assets/68bb94d3-75ce-4398-a9f3-9fc56b2b76d5" />
